...
namespace Nuve.NGrams
{
    ...
    ///     See <see cref="ExtractAsSet" />, <see cref="ExtractAsList" />, and <see cref="ExtractAsDictionary" /> for more
    ///     detail.
    /// </summary>
    public class NGramExtractor
    {
        ...
        public int MinNGramSize
        {
            get { return minNGramSize; }
        }

        public int MaxNGramSize
        {
            get { return maxNGramSize; }
        }
