...
{
    class PronounConjugationTest
    {

        [TestCase("ben",  new [] { "ben/ZAMIR_SAHIS_BEN" })]
        [TestCase("benim", new[] { "ben/ZAMIR_SAHIS_BEN nUn/IC_HAL_ILGI_(n)Un", "ben/ZAMIR_SAHIS_BEN yUm/EKFIIL_SAHIS_BEN_(y)Um" })]
        [TestCase("benimdir", new[] { "ben/ZAMIR_SAHIS_BEN nUn/IC_HAL_ILGI_(n)Un DUr/EKFIIL_TANIMLAMA_DUr", "ben/ZAMIR_SAHIS_BEN yUm/EKFIIL_SAHIS_BEN_(y)Um DUr/EKFIIL_TANIMLAMA_DUr" })]
        ...
        [TestCase("bizlerizdir", new[] { "biz/ZAMIR_SAHIS_BIZ lAr/ZAMIR_COGUL_lAr yUz/EKFIIL_SAHIS_BIZ_(y)Uz DUr/EKFIIL_TANIMLAMA_DUr", })]
        ...
        [TestCase("sizlersinizdir", new[] { "siz/ZAMIR_SAHIS_SIZ lAr/ZAMIR_COGUL_lAr sUnUz/EKFIIL_SAHIS_SIZ_sUnUz DUr/EKFIIL_TANIMLAMA_DUr", })]
        ...
        [TestCase("bunu", new[] { "bu/ZAMIR_ISARET yU/IC_HAL_BELIRTME_(y)U", "bu/ZAMIR_ISARET yU/IC_HAL_BELIRTME_(y)U", })]
        [TestCase("buna", new[] { "bu/ZAMIR_ISARET yA/IC_HAL_YONELME_(y)A", "bu/ZAMIR_ISARET yA/IC_HAL_YONELME_(y)A", })]
        [TestCase("bunda", new[] { "bu/ZAMIR_ISARET DA/IC_HAL_BULUNMA_DA", "bu/ZAMIR_ISARET DA/IC_HAL_BULUNMA_DA", })]
        [TestCase("bundan", new[] { "bu/ZAMIR_ISARET DAn/IC_HAL_AYRILMA_DAn", "bu/ZAMIR_ISARET DAn/IC_HAL_AYRILMA_DAn", })]
        [TestCase("bunun", new[] { "bu/ZAMIR_ISARET nUn/IC_HAL_ILGI_(n)Un", "bu/ZAMIR_ISARET nUn/IC_HAL_ILGI_(n)Un", })]
        [TestCase("bununla", new[] { "bu/ZAMIR_ISARET nUn/IC_HAL_ILGI_(n)Un ylA/IC_HAL_VASITA_(y)lA", "bu/ZAMIR_ISARET nUn/IC_HAL_ILGI_(n)Un ylA/IC_HAL_VASITA_(y)lA", })]
        [TestCase("bunca", new[] { "bu/ZAMIR_ISARET CA/IY_ZARF_CA", "bu/ZAMIR_ISARET CA/IY_ZARF_CA", })]
        [TestCase("bunsuz", new[] { "bu/ZAMIR_ISARET sUz/IY_SIFAT_sUz", "bu/ZAMIR_ISARET sUz/IY_SIFAT_sUz", })]
        [TestCase("budur", new[] { "bu/ZAMIR_ISARET DUr/EKFIIL_TANIMLAMA_DUr", })]
        [TestCase("bunundur", new[] { "bu/ZAMIR_ISARET nUn/IC_HAL_ILGI_(n)Un DUr/EKFIIL_TANIMLAMA_DUr", "bu/ZAMIR_ISARET nUn/IC_HAL_ILGI_(n)Un DUr/EKFIIL_TANIMLAMA_DUr", })]
        [TestCase("bununki", new[] { "bu/ZAMIR_ISARET nUn/IC_HAL_ILGI_(n)Un ki/IC_AITLIK_ki", "bu/ZAMIR_ISARET nUn/IC_HAL_ILGI_(n)Un ki/IC_AITLIK_ki", })]
        ...
        [TestCase("bunlarındır", new[] { "bu/ZAMIR_ISARET lAr/ZAMIR_COGUL_lAr nUn/IC_HAL_ILGI_(n)Un DUr/EKFIIL_TANIMLAMA_DUr", })]
        ...
        [TestCase("bunlarsız", new[] { "eksik" })]
        [TestCase("şunlarsız", new[] { "eksik" })]
        ...
        [TestCase("kendiniz", new[] { "kendi/ZAMIR_DONUSLULUK Un/IC_SAHIPLIK_SEN_(U)n yUz/EKFIIL_SAHIS_BIZ_(y)Uz", "kendi/ZAMIR_DONUSLULUK UnUz/IC_SAHIPLIK_SIZ_(U)nUz", })]
        ...
        [TestCase("kendini", new[] { "kendi/ZAMIR_DONUSLULUK Un/IC_SAHIPLIK_SEN_(U)n yU/IC_HAL_BELIRTME_(y)U", "kendi/ZAMIR_DONUSLULUK yU/IC_HAL_BELIRTME_(y)U", })]
        ...
        [TestCase("kendinin", new[] { "kendi/ZAMIR_DONUSLULUK Un/IC_SAHIPLIK_SEN_(U)n nUn/IC_HAL_ILGI_(n)Un", "kendi/ZAMIR_DONUSLULUK nUn/IC_HAL_ILGI_(n)Un", })]
        ...
        [TestCase("kendine", new[] { "kendi/ZAMIR_DONUSLULUK Un/IC_SAHIPLIK_SEN_(U)n yA/IC_HAL_YONELME_(y)A", "kendi/ZAMIR_DONUSLULUK yA/IC_HAL_YONELME_(y)A", })]
        ...
        [TestCase("kendinde", new[] { "kendi/ZAMIR_DONUSLULUK Un/IC_SAHIPLIK_SEN_(U)n DA/IC_HAL_BULUNMA_DA", "kendi/ZAMIR_DONUSLULUK DA/IC_HAL_BULUNMA_DA", })]
        ...
        [TestCase("kendinden", new[] { "kendi/ZAMIR_DONUSLULUK Un/IC_SAHIPLIK_SEN_(U)n DAn/IC_HAL_AYRILMA_DAn", "kendi/ZAMIR_DONUSLULUK DAn/IC_HAL_AYRILMA_DAn", })]
        ...
        [TestCase("kendince", new[] { "kendi/ZAMIR_DONUSLULUK Un/IC_SAHIPLIK_SEN_(U)n CA/IY_ZARF_CA", "kendi/ZAMIR_DONUSLULUK CA/IY_ZARF_CA", })]
        ...
        [TestCase("kendinizdir", new[] { "kendi/ZAMIR_DONUSLULUK Un/IC_SAHIPLIK_SEN_(U)n yUz/EKFIIL_SAHIS_BIZ_(y)Uz DUr/EKFIIL_TANIMLAMA_DUr", "kendi/ZAMIR_DONUSLULUK UnUz/IC_SAHIPLIK_SIZ_(U)nUz DUr/EKFIIL_TANIMLAMA_DUr", })]
        [TestCase("kendileridir", new[] { "kendi/ZAMIR_DONUSLULUK lArI/IC_SAHIPLIK_ONLAR_lArI DUr/EKFIIL_TANIMLAMA_DUr", })]
        [TestCase("kendiliğimden", new[] { "kendi/ZAMIR_DONUSLULUK lUk/IY_ISIM_lUK Um/IC_SAHIPLIK_BEN_(U)m DAn/IC_HAL_AYRILMA_DAn", })]
        [TestCase("kendiliğinden", new[] { "kendi/ZAMIR_DONUSLULUK lUk/IY_ISIM_lUK sU/IC_SAHIPLIK_O_(s)U DAn/IC_HAL_AYRILMA_DAn", "kendi/ZAMIR_DONUSLULUK lUk/IY_ISIM_lUK Un/IC_SAHIPLIK_SEN_(U)n DAn/IC_HAL_AYRILMA_DAn", })]
        [TestCase("kendiliğimizden", new[] { "kendi/ZAMIR_DONUSLULUK lUk/IY_ISIM_lUK UmUz/IC_SAHIPLIK_BIZ_(U)mUz DAn/IC_HAL_AYRILMA_DAn", })]
        [TestCase("kendiliğinizden", new[] { "kendi/ZAMIR_DONUSLULUK lUk/IY_ISIM_lUK UnUz/IC_SAHIPLIK_SIZ_(U)nUz DAn/IC_HAL_AYRILMA_DAn", })]
        [TestCase("kendiliklerinden", new[] { "kendi/ZAMIR_DONUSLULUK lUk/IY_ISIM_lUK lArI/IC_SAHIPLIK_ONLAR_lArI DAn/IC_HAL_AYRILMA_DAn", })]
        ...
        [TestCase("kimleri", new[] { "kim/ZAMIR_SORU lAr/IC_COGUL_lAr sU/IC_SAHIPLIK_O_(s)U", "kim/ZAMIR_SORU lAr/IC_COGUL_lAr yU/IC_HAL_BELIRTME_(y)U", "kim/ZAMIR_SORU lArI/IC_SAHIPLIK_ONLAR_lArI", })]
        [TestCase("kimin", new[] { "kim/ZAMIR_SORU Un/IC_SAHIPLIK_SEN_(U)n", "kim/ZAMIR_SORU nUn/IC_HAL_ILGI_(n)Un", })]
        [TestCase("kimlerin", new[] { "kim/ZAMIR_SORU lAr/IC_COGUL_lAr Un/IC_SAHIPLIK_SEN_(U)n", "kim/ZAMIR_SORU lAr/IC_COGUL_lAr nUn/IC_HAL_ILGI_(n)Un", })]
        ...
        [TestCase("kiminiz", new[] { "kim/ZAMIR_SORU Un/IC_SAHIPLIK_SEN_(U)n yUz/EKFIIL_SAHIS_BIZ_(y)Uz", "kim/ZAMIR_SORU UnUz/IC_SAHIPLIK_SIZ_(U)nUz", })]
        [TestCase("kimimi", new[] { "kim/ZAMIR_SORU Um/IC_SAHIPLIK_BEN_(U)m yU/IC_HAL_BELIRTME_(y)U", })]
        [TestCase("kimini", new[] { "kim/ZAMIR_SORU sU/IC_SAHIPLIK_O_(s)U yU/IC_HAL_BELIRTME_(y)U", "kim/ZAMIR_SORU Un/IC_SAHIPLIK_SEN_(U)n yU/IC_HAL_BELIRTME_(y)U", })]
        ...
        [TestCase("kiminin", new[] { "kim/ZAMIR_SORU sU/IC_SAHIPLIK_O_(s)U nUn/IC_HAL_ILGI_(n)Un", "kim/ZAMIR_SORU Un/IC_SAHIPLIK_SEN_(U)n nUn/IC_HAL_ILGI_(n)Un", })]
        ...
        [TestCase("kimine", new[] { "kim/ZAMIR_SORU sU/IC_SAHIPLIK_O_(s)U yA/IC_HAL_YONELME_(y)A", "kim/ZAMIR_SORU Un/IC_SAHIPLIK_SEN_(U)n yA/IC_HAL_YONELME_(y)A", })]
        ...
        [TestCase("kiminde", new[] { "kim/ZAMIR_SORU sU/IC_SAHIPLIK_O_(s)U DA/IC_HAL_BULUNMA_DA", "kim/ZAMIR_SORU Un/IC_SAHIPLIK_SEN_(U)n DA/IC_HAL_BULUNMA_DA", })]
        ...
        [TestCase("kiminden", new[] { "kim/ZAMIR_SORU sU/IC_SAHIPLIK_O_(s)U DAn/IC_HAL_AYRILMA_DAn", "kim/ZAMIR_SORU Un/IC_SAHIPLIK_SEN_(U)n DAn/IC_HAL_AYRILMA_DAn", })]
        ...
        [TestCase("kiminle", new[] { "kim/ZAMIR_SORU Un/IC_SAHIPLIK_SEN_(U)n ylA/IC_HAL_VASITA_(y)lA", "kim/ZAMIR_SORU nUn/IC_HAL_ILGI_(n)Un ylA/IC_HAL_VASITA_(y)lA", })]
        ...
        [TestCase("kimisininki", new[] { "kimi/ZAMIR_BELIRSIZLIK sU/IC_SAHIPLIK_O_(s)U nUn/IC_HAL_ILGI_(n)Un ki/IC_AITLIK_ki", })]
        [TestCase("kimisinindir", new[] { "kimi/ZAMIR_BELIRSIZLIK sU/IC_SAHIPLIK_O_(s)U nUn/IC_HAL_ILGI_(n)Un DUr/EKFIIL_TANIMLAMA_DUr", })]
        ...
        [TestCase("kimilerininki", new[] { "kimi/ZAMIR_BELIRSIZLIK lArI/IC_SAHIPLIK_ONLAR_lArI nUn/IC_HAL_ILGI_(n)Un ki/IC_AITLIK_ki", })]
        [TestCase("kimilerinindir", new[] { "kimi/ZAMIR_BELIRSIZLIK lArI/IC_SAHIPLIK_ONLAR_lArI nUn/IC_HAL_ILGI_(n)Un DUr/EKFIIL_TANIMLAMA_DUr", })]
