...
namespace Nuve.Test.Tokenizers
{
    ...
    internal class TokenizerTest
    {
        ...
        [TestCase("aa33bb", Result = new object[] {"aa", "33", "bb"})]
        [TestCase("30cm isyankar44", Result = new object[] {"30", "cm", " ", "isyankar", "44"})]
        ...
        [TestCase("(a)", Result = new object[] {"(", "a", ")"})]
        [TestCase("Prof. Dr.", Result = new object[] {"Prof", ".", " ", "Dr", ".",})]
        [TestCase("harun.zafer@tubitak.gov.tr",
            Result = new object[] {"harun", ".", "zafer", "@", "tubitak", ".", "gov", ".", "tr"})]
        [TestCase("Kur'an-ı Kerim", Result = new object[] {"Kur", "'", "an", "-", "ı", " ", "Kerim"})]
        [TestCase("Kuran-ı Kerim", Result = new object[] {"Kuran", "-", "ı", " ", "Kerim"})]
        [TestCase("TL-WA854RE'nin", Result = new object[] {"TL", "-", "WA", "854", "RE", "'", "nin"})]
        ...
        [TestCase("Please, email john.doe@foo.com by 03-09, re: m37-xq.",
            Result =
                new object[]
                {
                    "Please", ",", " ", "email", " ", "john", ".", "doe", "@", "foo", ".", "com", " ", "by", " ", "03",
                    "-",
                    "09", ",", " ", "re", ":", " ", "m", "37", "-", "xq", "."
                })]
        public IList<string> FullTokenizerTest(string text)
        {
